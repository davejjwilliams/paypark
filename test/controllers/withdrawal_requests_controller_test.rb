...
class WithdrawalRequestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create withdrawal_request" do
    assert_difference('WithdrawalRequest.count') do
      post withdrawal_requests_url, params: { withdrawal_request: { amount: @withdrawal_request.amount, homeowner_id: @withdrawal_request.homeowner_id, request_date: @withdrawal_request.request_date } }
    end
  ...
  test "should update withdrawal_request" do
    ...
    assert_redirected_to withdrawal_request_url(@withdrawal_request)
  end
